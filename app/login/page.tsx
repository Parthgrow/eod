  ...
  return (
    <div className="flex flex-1 items-center justify-center min-h-screen bg-zinc-50 dark:bg-black px-6">
      ...
      >
        ...
        {/* Wired up once lib/auth/index.ts registers a "google" provider — see AuthProvider/OAuthProvider in lib/auth/types.ts */}
        <button
          type="button"
          disabled
          title="Coming soon"
          className="flex items-center justify-center gap-2 rounded-full border border-zinc-200 dark:border-zinc-700 px-4 py-2 text-sm font-medium text-zinc-400 dark:text-zinc-600 cursor-not-allowed"
        >
